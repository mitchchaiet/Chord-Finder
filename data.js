	...
	return {
		init: function(){
			...
			$('#key ul li').click(function() {
				...
				//Major Chords
				buildFrets(keys[id].major_chords[0].tonic[0].chord,keys[id].major_chords[0].tonic[0].modf, 0, id, 'tonic');
				buildFrets(keys[id].major_chords[0].sub_dom[0].chord,keys[id].major_chords[0].sub_dom[0].modf, 1,id,'sub_dom');
				buildFrets(keys[id].major_chords[0].dom[0].chord,keys[id].major_chords[0].dom[0].modf,2,id,'dom');
				//Accidental Chords
				buildFrets(keys[id].accidental_chords[0].dbl_dom[0].chord,keys[id].accidental_chords[0].dbl_dom[0].modf,3,id,'dbl_dom');
				buildFrets(keys[id].accidental_chords[0].tri_dom[0].chord,keys[id].accidental_chords[0].tri_dom[0].modf,4,id,'tri_dom');
				buildFrets(keys[id].accidental_chords[0].dom_rel_minor[0].chord,keys[id].accidental_chords[0].dom_rel_minor[0].modf,5,id,'dom_rel_minor');
				//Relative Chords
				buildFrets(keys[id].relative_minor_chords[0].minor0[0].chord,keys[id].relative_minor_chords[0].minor0[0].modf,6,id,'minor0');
				buildFrets(keys[id].relative_minor_chords[0].minor1[0].chord,keys[id].relative_minor_chords[0].minor1[0].modf,7,id,'minor1');
				buildFrets(keys[id].relative_minor_chords[0].minor2[0].chord,keys[id].relative_minor_chords[0].minor2[0].modf,8,id,'minor2');
